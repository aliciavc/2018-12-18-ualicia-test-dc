...
venue: "Alicia's House"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Basement, 419 Nichols Cove Rd, Trent Lakes, ON"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humantime: "10am to 6pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Alicia Cappello", "Jasmine Cappello"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ben Cappello", "Jasper Cappello"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["cappello@ualberta.ca"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
